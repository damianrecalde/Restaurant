...
<a class="btn btn-primary" href="{{ route('principales.index') }}">Cancelar</a>
</div>
</div>
</div>
@if(session('status'))
...
@endif
<form action="{{ route('principales.store') }}" method="POST" enctype="multipart/form-data">
@csrf
<div class="row">
<div class="col-xs-12 col-sm-12 col-md-12">
<div class="form-group">
<strong>Nombre:</strong>
<input type="text" name="nombre" class="form-control" placeholder="Principal nombre">
@error('nombre')
